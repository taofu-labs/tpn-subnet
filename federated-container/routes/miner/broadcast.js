...
import { find_first_valid_workers_by_ip, validate_and_annotate_workers } from '../../modules/scoring/score_workers.js'
...
router.post( '/worker', async ( req, res ) => {
    ...
    try {
        ...
        if( clashing_workers.length ) {
            ...
            const cleared_clashing_workers = await find_first_valid_workers_by_ip( { workers: [ worker, ...clashes_with_workers ] } )
